...
/**
 * Created by liujianwei on 15/7/6.
 * 支持H5文件单独升级的项目，必须调用setIsSupportH5Upgrade(true)
 * 小贷
 */
public class LoanFragment extends BaseWebFragment implements IWebModule {
    //不需要支持h5文件单独升级的项目，采用如下url格式
    public final static String assert_url = "file:///android_asset/www/m/loan/index.html";
    //支持H5文件单独升级的项目，采用如下url格式
    public final static String url = "www/m/loan/index.html";
    ...
    @Override
    /**
     * 放回一个webview的名字，用于做预加载，如果不做预加载的项目，简单一点可直接返回null
     */
