...
import com.thinkive.android.trade_bz.a_out.bll.FundHistoryTradeServicesImpl;
import com.thinkive.android.trade_bz.a_stock.controll.AbsBaseController;
import com.thinkive.android.trade_bz.a_out.adapter.FundHistoryTradeAdapter;
 ...
 * @date 2015/7/24
 */
public class FundHistoryTradeFragment extends AbsBaseFragment {
    /**
     *   基金交易--查询--历史成交的宿主
     */
     ...
     *   控制基金交易--查询--历史成交
     */
    private FundHistoryTradeController mController;
    /**
     * 查询开始时间
     */
     ...
     * 业务类
     */
    private FundHistoryTradeServicesImpl mServices;
    /**
     * 适配器
     */
    private FundHistoryTradeAdapter mAdapter;
    /**
     *  ListView
     */
    ...
    protected void initData() {
        ...
        mController=new FundHistoryTradeController(this);
        mServices=new FundHistoryTradeServicesImpl(this);
        mAdapter=new FundHistoryTradeAdapter(mActivity);
     ...
     * @param dataList
     */
    public void onGetHistoryTradeData(ArrayList<FundHistoryTradeBean> dataList){
 ...
 * 控制基金交易--查询--历史成交
 */
class FundHistoryTradeController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener,View.OnClickListener {

    private FundHistoryTradeFragment mFragment;

    public FundHistoryTradeController(FundHistoryTradeFragment fragment) {
