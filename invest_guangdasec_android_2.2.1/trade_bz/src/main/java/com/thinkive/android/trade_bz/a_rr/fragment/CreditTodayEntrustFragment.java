...
import com.thinkive.android.trade_bz.a_rr.activity.CreditTodayEntrustDetailActivity;
import com.thinkive.android.trade_bz.a_rr.adapter.CreditTodayEntrustAdapter;
import com.thinkive.android.trade_bz.a_rr.bean.RSelectTodayEntrustBean;
import com.thinkive.android.trade_bz.a_rr.bll.CreditTodayEntrustServicesImpl;
import com.thinkive.android.trade_bz.a_rr.controll.CreditTodayEntrustController;
 ...
 * @date 2015/6/19
 */
public class CreditTodayEntrustFragment extends AbsBaseFragment {
    /**
     * 该类的宿主Activity
     */
     ...
     * 数据的LisView的适配器
     */
    private CreditTodayEntrustAdapter mAdapter;
    /**
     * 该类的业务类
     */
    private CreditTodayEntrustServicesImpl mServiceImpl = null;
    /**
     * 如果没有数据就显示该图片
     */
     ...
     * 控制我的持仓
     */
    private CreditTodayEntrustController mController;
    /**
     * 正在加载的旋转进度条
     */
    ...
    protected void initData() {
        ...
        mServiceImpl = new CreditTodayEntrustServicesImpl(this);
        mController = new CreditTodayEntrustController(this);
        mAdapter = new CreditTodayEntrustAdapter(mActivity);
    }
    ...
    public void onClickExpandDetails(int position) {
        ...
        RSelectTodayEntrustBean bean = mAdapter.getItem(position);
        Intent intent = new Intent(getActivity(), CreditTodayEntrustDetailActivity.class);
