...
import com.thinkive.android.trade_bz.a_option.adapter.OptionHistoryTradeAdapter;
import com.thinkive.android.trade_bz.a_option.bean.OptionHistoryTradeBean;
import com.thinkive.android.trade_bz.a_option.bll.OptionHistoryTradeServicesImpl;
 ...
 * @date 2016/6/15
 */
public class OptionHistoryTradeFragment extends AbsBaseFragment {
    private TKFragmentActivity mActivity;
    private OptionHistoryTradeServicesImpl mServices;
    private OptionHistoryTradeAdapter mAdapter;
    private OptionHistoryTradeController mController;
    /**
     * 查询开始时间
     */
    ...
    protected void initData() {
        ...
        mController=new OptionHistoryTradeController(this);
        mServices=new OptionHistoryTradeServicesImpl(this);
        mAdapter=new OptionHistoryTradeAdapter(mActivity);
     ...
     * @param dataList
     */
    public void onGetHistoryEntrustData(ArrayList<OptionHistoryTradeBean> dataList){
...
class OptionHistoryTradeController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener,View.OnClickListener{

    private OptionHistoryTradeFragment mFragment;
    public OptionHistoryTradeController(OptionHistoryTradeFragment fragment) {
