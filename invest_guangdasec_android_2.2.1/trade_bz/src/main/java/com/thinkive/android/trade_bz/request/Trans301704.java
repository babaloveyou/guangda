 ...
 * @date 2016/1/5
 */
public class Trans301704 extends BaseNormalRequest {

    public static final String BUNDLE_KEY_REVOCATION = "Trans301704";

    public Trans301704(HashMap<String, String> paramMap, IRequestAction action) {
        super(action);
        paramMap.put("funcNo", "301704");
