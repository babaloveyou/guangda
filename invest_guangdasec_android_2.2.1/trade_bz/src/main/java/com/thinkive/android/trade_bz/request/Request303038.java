...
/**
 * 融资融券--银证转账--查询转帐银行业务信息
 * @author 张雪梅
 * @company Thinkive
 * @date 2015/8/24
 */
public class Request303038 extends BaseCreditRequest {

    public static final String BUNDLE_KEY_R_OTHER_MONEY = "Request303038_result";

    public Request303038(HashMap<String, String> paramMap, IRequestAction action) {
        super(action);
        paramMap.put("funcNo", "303038");
