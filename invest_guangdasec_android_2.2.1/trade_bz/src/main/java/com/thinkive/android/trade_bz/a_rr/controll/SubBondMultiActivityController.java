 ...
 */
public class SubBondMultiActivityController  extends AbsBaseController implements
        NavigatorView.OnTabClickListener, NavigatorView.OnTabLightChangeListener,
        HorizontalSlideLinearLayout.OnSlideListener {

    private SubBondMultiActivity mActivity = null;

    public SubBondMultiActivityController(SubBondMultiActivity activity) {
        mActivity = activity;
    }
