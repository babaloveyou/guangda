 ...
 * @date 2015/12/1
 */
public class NewStock303028 extends BaseCreditRequest {

    public static final String BUNDLE_KEY_SUBSDRIBE = "Request303028_result";

    public NewStock303028(HashMap<String, String> paramMap, IRequestAction action) {
        super(action);
        paramMap.put("funcNo", "303028");
