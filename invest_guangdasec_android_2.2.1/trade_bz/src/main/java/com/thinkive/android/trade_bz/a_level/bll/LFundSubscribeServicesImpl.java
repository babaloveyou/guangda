...
public class LFundSubscribeServicesImpl {
    private LFundSubscribeFragment mFragment = null;
    private LoadingDialogUtil loadingDialogUtil;//请求数据状态框 工具类

    public LFundSubscribeServicesImpl(LFundSubscribeFragment fragment) {
        mFragment = fragment;
     ...
     * @param code
     */
    public void requestFundSubscribe(String type, String account,String code,String money) {
        loadingDialogUtil.showLoadingDialog(0);
        HashMap<String, String> map = new HashMap<String, String>();
        map.put("entrust_bs","20");
        map.put("stock_code", code);
//        map.put("entrust_price", money);
        map.put("entrust_amount",money);
        if(type != null){
        ...
        new Request301501(map, new IRequestAction() {
            ...
            public void onSuccess(Context context, Bundle bundle) {
                ...
                mFragment.getFundSubscribe(bundle.getString(Request301501.BUNDLE_KEY_RESULT));
            }
