...
public class SqqSwitchButton extends View implements ValueAnimator.AnimatorUpdateListener {
    /*	*//** 圆圈的开始和结束位置 *//*
    ...
    private float spotX;
    /** 开启颜色*/
    private int onColor = Color.parseColor("#4359aa");
    /** 关闭颜色 */
    private int offBorderColor = Color.parseColor("#f5f5f5");
    /** 边框颜色 */
