...
import com.thinkive.android.trade_bz.a_stock.fragment.TradeWebCacheFragment;

import java.util.HashMap;

/**
 * WebFragment管理类，负责给所有WebFragment做预加载，
 * 并提供索引Map让Activity类能够找到所需的WebFragment
 * @author 王志鸿
 * @company Thinkive
 * @date 2015/10/15
 */
public class TradeWebFragmentManager {
     ...
     */
    private HashMap<String, TradeWebCacheFragment> mCacheFragmentHashMap;
    /**
     * 框架的webview管理类，管理所有webFragment中用到的webview
     */
    private WebViewManager mWebViewManager;

    public static TradeWebCacheFragment sWebCacheFragment = new TradeWebCacheFragment();
    ...
    private TradeWebFragmentManager() {
        ...
        mCacheFragmentHashMap = new HashMap<String, TradeWebCacheFragment>();
    }
     ...
     */
    public void putCacheFragment(String key, TradeWebCacheFragment fragment){
     ...
     * @return
     */
    public TradeWebCacheFragment getWebCacheFragment(String key) {
    ...
    public void preLoadUrl(String key) {
        TradeWebCacheFragment fragment = mCacheFragmentHashMap.get(key);
        // 获取要加载的url
