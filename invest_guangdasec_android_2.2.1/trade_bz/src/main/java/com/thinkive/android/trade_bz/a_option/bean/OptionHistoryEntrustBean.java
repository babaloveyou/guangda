 ...
 * @date 2016/6/14
 */
public class OptionHistoryEntrustBean extends BaseBean {
    @JsonKey("entrust_no")
    ...
    @JsonKey("entrust_prop_name")
    private String entrust_prop_name = ""; //  委托属性名称
    @JsonKey("entrust_status")
    private String entrust_status = ""; //委托状态(见数据字典)
    ...
    public OptionHistoryEntrustBean() {
    ...
    public String getEntrust_prop_name() {
        return entrust_prop_name;
    }

    public void setEntrust_prop_name(String entrust_prop_name) {
        this.entrust_prop_name = entrust_prop_name;
    }
