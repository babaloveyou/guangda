 ...
 */
public class SubBondAdapter extends AbsBaseAdapter<RSelectCollaterSecurityBean> {
    private Context mContext;

    public SubBondAdapter(Context context) {
        super(context, R.layout.item_r_sub_bond);
        mContext = context;
    }
