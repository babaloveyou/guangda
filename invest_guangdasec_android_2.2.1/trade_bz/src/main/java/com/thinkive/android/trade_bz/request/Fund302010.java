 ...
 * @date 2015/10/27
 */
public class Fund302010 extends BaseNormalRequest {

    public static final String BUNDLE_KEY_ONE_KEY_CONVERT= "Request302010_result";

    public Fund302010(HashMap<String, String> paramMap, IRequestAction action) {
        super(action);
        paramMap.put("funcNo", "302010");
        ...
        try {
            ...
            PublicUseBean bean;
                ...
                if (jsonResult != null && bean !=null) {
                    bundle.putSerializable(BUNDLE_KEY_ONE_KEY_CONVERT, bean);
