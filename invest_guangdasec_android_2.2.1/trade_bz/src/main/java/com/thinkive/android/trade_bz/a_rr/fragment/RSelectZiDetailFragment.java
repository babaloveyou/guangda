...
import com.thinkive.android.trade_bz.a_rr.adapter.RSelectZiDetailAdapter;
import com.thinkive.android.trade_bz.a_rr.bean.RSelectContractBean;
import com.thinkive.android.trade_bz.a_rr.bll.RSelectZiDetailServiceImpl;
 ...
 */
public class RSelectZiDetailFragment extends AbsBaseFragment implements OnDateSetListener {
    /**
     *适配器
     */
    private RSelectZiDetailAdapter mAdapter;
    /**
     *Fragment的宿主
     */
    private RSelectCreditZiDetailActivity mActivity;
    /**
     *该Fragement的业务类
     */
    private RSelectZiDetailServiceImpl mServices;
    /**
     * 该类的控制器
     */
    private ZiDetailController mController;
    /**
     * 开始时间
     */
    ...
    protected void initData() {
        mActivity = (RSelectCreditZiDetailActivity) getActivity();
        mAdapter = new RSelectZiDetailAdapter(mActivity);
        mServices = new RSelectZiDetailServiceImpl(this);
        mController = new ZiDetailController(this);
    ...
    protected void initViews() {
        ...
        mServices.requestZiDetail(mBegin, mEnd);
        //设置禁止上拉加载更多
 ...
 * 控制类
 */
class ZiDetailController extends AbsBaseController implements PullToRefreshListView.OnRefreshListener,
        View.OnClickListener {
    private RSelectZiDetailFragment mFragment;
    public ZiDetailController(RSelectZiDetailFragment fragment) {
        mFragment = fragment;
    }
    @Override
