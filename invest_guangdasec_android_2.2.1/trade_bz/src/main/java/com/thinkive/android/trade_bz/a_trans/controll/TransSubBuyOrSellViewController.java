 ...
 * @date 2016/5/26
 */
public class TransSubBuyOrSellViewController extends AbsBaseController implements
        View.OnClickListener, ListView.OnItemClickListener, TextWatcher,
        View.OnFocusChangeListener{

    private TransSubBuyOrSaleFragment mFragment = null;

    public TransSubBuyOrSellViewController(TransSubBuyOrSaleFragment fragment) {
        mFragment = fragment;
    }
