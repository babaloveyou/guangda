...
import com.thinkive.android.trade_bz.a_stock.activity.TodayTradeDetailActivity;
...
public class TodayTradeFragment extends AbsBaseFragment {
     ...
     * 该类的业务类
     */
    private TodayTradeServicesImpl mServiceImpl = null;
    /**
     * 如果没有数据就显示该图片
     */
    ...
    protected void initData() {
        ...
        mServiceImpl = new TodayTradeServicesImpl(this);
    ...
    public void onClickExpandDetails(int position) {
        ...
        HistoryTradeBean bean = mAdapter.getItem(position);
        Intent intent = new Intent(getActivity(), TodayTradeDetailActivity.class);
