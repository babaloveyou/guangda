 ...
 * @date 2016/1/20
 */
public class RCollaterBuyOrSaleViewController extends AbsBaseController implements
        View.OnClickListener, ListView.OnItemClickListener, TextWatcher,
         View.OnFocusChangeListener{

    private RCollaterBuyOrSellFragment mFragment = null;

    public RCollaterBuyOrSaleViewController(RCollaterBuyOrSellFragment fragment) {
        mFragment = fragment;
    }
