 ...
 */
public class CreditBottomTodayEntrustAdapter extends AbsBaseAdapter<RSelectTodayEntrustBean> {

    private Context mSubContext;
    private RSelectTodayEntrustServicesImpl mCreditService;
    public CreditBottomTodayEntrustAdapter(Context context, RSelectTodayEntrustServicesImpl services) {
        super(context, R.layout.item_bottom_today_entrust);
        mSubContext = context;
        mCreditService = services;
    }
