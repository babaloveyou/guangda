...
public class RSelectDOselectFragment extends AbsBaseFragment implements OnDateSetListener {
     ...
     *适配器
     */
    private RSelectDOselectAdapter mAdapter;
    /**
     *Fragment的宿主
     */
    private RSelectDOselectActivity mActivity;
    /**
     *该Fragement的业务类
     */
    private RSelectDOselectServiceImpl mServices;
    /**
     * 该类的控制器
     */
    private RDOViewController mController;
    /**
     * 开始时间
     */
    ...
    protected void initData() {
        mActivity = (RSelectDOselectActivity) getActivity();
     ...
     * @param dataList
     */
    public void getDeliveryOrderData(ArrayList<RSelectDOSelectBean> dataList) {
 ...
 * 控制类
 */
class RDOViewController extends AbsBaseController implements PullToRefreshListView.OnRefreshListener,
        View.OnClickListener {
    private RSelectDOselectFragment mFragment;
    public RDOViewController(RSelectDOselectFragment fragment) {
        mFragment = fragment;
    }
    @Override
