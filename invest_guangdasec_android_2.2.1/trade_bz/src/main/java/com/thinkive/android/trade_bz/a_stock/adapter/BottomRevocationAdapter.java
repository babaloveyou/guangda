 ...
 */
public class BottomRevocationAdapter extends AbsBaseAdapter<RevocationBean>{

    private Context mSubContext;
    private RevocationServicesImpl mRevocationServices;

    public BottomRevocationAdapter(Context context, RevocationServicesImpl mServices) {
