...
import com.thinkive.android.trade_bz.a_option.adapter.OptionTodayTradeAdapter;
import com.thinkive.android.trade_bz.a_option.bean.OptionTodayTradeBean;
import com.thinkive.android.trade_bz.a_option.bll.OptionTodayTradeServicesImpl;
 ...
 * @date 2016/6/15
 */
public class OptionTodayTradeFragment extends AbsBaseFragment {
    private TKFragmentActivity mActivity;
    private OptionTodayTradeServicesImpl mServices;
    private OptionTodayTradeController mController;
    private OptionTodayTradeAdapter mAdapter;
    ...
    protected void initData() {
        ...
        mAdapter =new OptionTodayTradeAdapter(mActivity);
        mServices=new OptionTodayTradeServicesImpl(this);
        mController=new OptionTodayTradeController(this);
    }
     ...
     * @param dataList
     */
    public void onGetTodayTradeData(ArrayList<OptionTodayTradeBean> dataList) {
...
class OptionTodayTradeController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener{

    private OptionTodayTradeFragment mFragment = null;

    public OptionTodayTradeController(OptionTodayTradeFragment Fragment) {
        mFragment = Fragment;
    }
