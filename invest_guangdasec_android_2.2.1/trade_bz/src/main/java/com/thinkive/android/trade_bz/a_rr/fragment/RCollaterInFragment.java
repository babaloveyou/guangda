...
public class RCollaterInFragment extends AbsBaseFragment {
    ...
    protected void initData() {
        ...
        mController=new RCollaterInViewController(this);
        mServices=new RCollaterInServiceImpl(this);
        mAdapter=new RCollaterInAdapter(mActivity,mServices,this);
    }
...
class RCollaterInViewController extends AbsBaseController implements PullToRefreshListView.OnRefreshListener{

    private RCollaterInFragment mFragment;

    public RCollaterInViewController(RCollaterInFragment Fragment) {
        mFragment = Fragment;
    }
