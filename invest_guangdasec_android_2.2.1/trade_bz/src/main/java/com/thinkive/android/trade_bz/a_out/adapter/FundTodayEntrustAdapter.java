...
public class FundTodayEntrustAdapter extends AbsBaseAdapter<FundTodayEntrustBean> {
    private Context mContext;
    private FontManager mFontManager;
    public FundTodayEntrustAdapter(Context context) {
        super(context,R.layout.item_fund_today_entrust);
        mContext = context;
        mFontManager = FontManager.getInstance(mContext);
    }
    @Override
    protected void onFillComponentData(ViewHolder holder, FundTodayEntrustBean bean) {
