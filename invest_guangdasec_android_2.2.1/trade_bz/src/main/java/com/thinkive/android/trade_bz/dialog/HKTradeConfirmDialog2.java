 ...
 * @date 2016/6/6
 */
public class HKTradeConfirmDialog2 extends AbsTradeDialog {
    /**
     * 股票名称
     */
     ...
     * 调用方的业务类
     */
    private HKOtherSaleServiceImpl mService;

    public HKTradeConfirmDialog2(Context context, HKOtherSaleServiceImpl service) {
        super(context);
        mService = service;
        initDialogLayout();
        setLayout();
