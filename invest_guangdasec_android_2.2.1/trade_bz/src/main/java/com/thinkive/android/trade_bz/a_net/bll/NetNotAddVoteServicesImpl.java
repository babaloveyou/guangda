 ...
 * @date 2016/8/5
 */
public class NetNotAddVoteServicesImpl {

    private NetNotAddUpVoteFragment mFragment = null;
    private LoadingDialogUtil loadingDialogUtil;//请求数据状态框 工具类

    public NetNotAddVoteServicesImpl(NetNotAddUpVoteFragment mFragment) {
    ...
    public void requestCommitVote(HashMap<String, String> resultMap) {
        ...
        map.put("vote_number", "0");
        //投票意见 普通：1赞同 2反对 3弃权  累计：固定填1(多个用逗号分隔，)
        map.put("vote_result", resultMap.get("vote_result"));
