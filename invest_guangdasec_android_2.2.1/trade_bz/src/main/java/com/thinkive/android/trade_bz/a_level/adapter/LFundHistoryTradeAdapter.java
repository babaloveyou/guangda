...
public class LFundHistoryTradeAdapter extends AbsBaseAdapter<LFundTradeDataBean> {
    private Context mContext;
    private FontManager mFontManager;
    public LFundHistoryTradeAdapter(Context context) {
        super(context, R.layout.item_level_history_trade);
        mContext = context;
