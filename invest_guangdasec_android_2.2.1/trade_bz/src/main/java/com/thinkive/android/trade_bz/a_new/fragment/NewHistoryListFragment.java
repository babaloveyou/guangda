...
import com.thinkive.android.trade_bz.a_new.adapter.NewHistoryListAdapter;
import com.thinkive.android.trade_bz.a_new.bean.NewDistributeNumBean;
import com.thinkive.android.trade_bz.a_new.bll.NewHistoryListServicesImpl;
 ...
 * @date 2016/6/22
 */
public class NewHistoryListFragment extends AbsBaseFragment {
    private NewHistoryListServicesImpl mServices;
    private TKFragmentActivity mActivity;
    private NewHistoryListAdapter mAdapter;
    private NewHistoryListController mController;
    /**
     * ListView
     */
    ...
    protected void initData() {
        ...
        mServices =new NewHistoryListServicesImpl(this,mUserType);
        mAdapter =new NewHistoryListAdapter(mActivity);
        mController=new NewHistoryListController(this);
...
class NewHistoryListController extends AbsBaseController implements PullToRefreshListView.OnRefreshListener,
        View.OnClickListener{

    private NewHistoryListFragment mFragment = null;

    public NewHistoryListController(NewHistoryListFragment Fragment) {
        mFragment = Fragment;
    }
