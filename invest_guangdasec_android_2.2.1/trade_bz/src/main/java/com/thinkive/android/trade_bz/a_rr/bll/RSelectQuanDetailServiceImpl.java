 ...
 */
public class RSelectQuanDetailServiceImpl extends BasicServiceImpl {

    private RSelectQuanDetailFragment mFragment;

    public RSelectQuanDetailServiceImpl(RSelectQuanDetailFragment fragment) {
        mFragment = fragment;
    }
    ...
    public void requestQuanDetail(String begin, String end) {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put("begin_date",begin);
        map.put("end_date",end);
        map.put("compact_type","1");
