...
import com.thinkive.android.trade_bz.a_rr.adapter.RSelectHistoryEntrustAdapter;
import com.thinkive.android.trade_bz.a_rr.bean.RSelectHistoryEntrustBean;
import com.thinkive.android.trade_bz.a_rr.bll.RSelectHistoryEntrustServicesImpl;
 ...
 * @date 2015/8/18
 */
public class RSelectHistoryEntrustFragment extends AbsBaseFragment {
    /**
     *历史委托数据适配器
     */
    private RSelectHistoryEntrustAdapter mAdapter;
    /**
     *历史委托 Fragment的宿主
     */
     ...
     *该Fragement的业务类
     */
    private RSelectHistoryEntrustServicesImpl mServices;
    /**
     * 该类的控制器
     */
    private RSelectEntrustController mController;
    /**
     * 查询开始时间
     */
    ...
    protected void initData() {
        ...
        mAdapter = new RSelectHistoryEntrustAdapter(mActivity);
        mServices = new RSelectHistoryEntrustServicesImpl(this);
        mController = new RSelectEntrustController(this);
     ...
     * @param dataList
     */
    public void getHistoryEntrustData(ArrayList<RSelectHistoryEntrustBean> dataList) {
 ...
 * 历史委托的控制类
 */
class RSelectEntrustController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener,View.OnClickListener {

    private RSelectHistoryEntrustFragment mFragment;

    public RSelectEntrustController(RSelectHistoryEntrustFragment fragment) {
