...
public class RSelectTodayTradeAdapter extends AbsBaseAdapter<RSelectTodayTradeBean> {
    private Context mSubContext;
    private FontManager mFontManager;

    public RSelectTodayTradeAdapter(Context context) {
        super(context, R.layout.item_r_select_today_trade);
        mSubContext = context;
        mFontManager = FontManager.getInstance(mSubContext);
    }

    @Override
    protected void onFillComponentData(ViewHolder holder, final RSelectTodayTradeBean bean) {
