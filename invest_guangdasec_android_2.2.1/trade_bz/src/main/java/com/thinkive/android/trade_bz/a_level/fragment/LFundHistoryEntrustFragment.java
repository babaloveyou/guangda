...
import com.thinkive.android.trade_bz.a_level.bll.LFundHistoryEntrustServicesImpl;
import com.thinkive.android.trade_bz.a_stock.controll.AbsBaseController;
import com.thinkive.android.trade_bz.a_level.adapter.LFundHistoryEntrustAdapter;
 ...
 * @date 15/11/10
 * */
public class LFundHistoryEntrustFragment extends AbsBaseFragment {
    private TKFragmentActivity mActivity;
    private LFundHistoryEntrustController mController;
    private LFundHistoryEntrustServicesImpl mServices;
    private LFundHistoryEntrustAdapter mAdapter;
    /**
     * ListView
     */
    ...
    protected void initData() {
        ...
        mController=new LFundHistoryEntrustController(this);
        mServices=new LFundHistoryEntrustServicesImpl(this);
        mAdapter=new LFundHistoryEntrustAdapter(mActivity);
     ...
     * @param dataList
     */
    public void onGetHistoryEntrustDataList(ArrayList<LFundEntrustDataBean>dataList){
...
class LFundHistoryEntrustController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener,
         View.OnClickListener{

    private LFundHistoryEntrustFragment mFragment = null;

    public LFundHistoryEntrustController(LFundHistoryEntrustFragment Fragment) {
        mFragment = Fragment;
    }
