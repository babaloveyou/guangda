...
import com.thinkive.android.trade_bz.a_option.adapter.OptionHistoryEntrustAdapter;
import com.thinkive.android.trade_bz.a_option.bean.OptionHistoryEntrustBean;
import com.thinkive.android.trade_bz.a_option.bll.OptionHistoryEntrustServicesImpl;
 ...
 * @date 2016/6/15
 */
public class OptionHistoryEntrustFragment extends AbsBaseFragment {
    private TKFragmentActivity mActivity;
    private OptionHistoryEntrustServicesImpl mServices;
    private OptionHistoryEntrustAdapter mAdapter;
    private OptionHistoryEntrustController mController;
    /**
     * 查询开始时间
     */
    ...
    protected void initData() {
        ...
        mController=new OptionHistoryEntrustController(this);
        mServices=new OptionHistoryEntrustServicesImpl(this);
        mAdapter=new OptionHistoryEntrustAdapter(mActivity);
     ...
     * @param dataList
     */
    public void onGetHistoryEntrustData(ArrayList<OptionHistoryEntrustBean> dataList){
...
class OptionHistoryEntrustController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener,View.OnClickListener{

    private OptionHistoryEntrustFragment mFragment;
    public OptionHistoryEntrustController(OptionHistoryEntrustFragment fragment) {
