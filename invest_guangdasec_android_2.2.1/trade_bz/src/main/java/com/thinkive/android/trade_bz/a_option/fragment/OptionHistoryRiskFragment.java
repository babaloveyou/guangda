...
import com.thinkive.android.trade_bz.a_option.adapter.OptionHistoryRiskAdapter;
import com.thinkive.android.trade_bz.a_option.bean.OptionHistoryRiskBean;
import com.thinkive.android.trade_bz.a_option.bll.OptionHistoryRiskServicesImpl;
 ...
 * @date 2016/7/28
 */
public class OptionHistoryRiskFragment extends AbsBaseFragment {
    private TKFragmentActivity mActivity;
    private OptionHistoryRiskServicesImpl mServices;
    private OptionHistoryRiskController mController;
    private OptionHistoryRiskAdapter mAdapter;
    /**
     * 查询开始时间
     */
    ...
    protected void initData() {
        ...
        mAdapter =new OptionHistoryRiskAdapter(mActivity);
        mServices=new OptionHistoryRiskServicesImpl(this);
        mController=new OptionHistoryRiskController(this);
    ...
    protected void initViews() {
        ...
        //请求数据
        mServices.requestHistoryRisk(mBegin, mEnd);
     ...
     * @param dataList
     */
    public void onGetHistoryRiskList(ArrayList<OptionHistoryRiskBean> dataList) {
...
class OptionHistoryRiskController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener,View.OnClickListener{

    private OptionHistoryRiskFragment mFragment = null;

    public OptionHistoryRiskController(OptionHistoryRiskFragment Fragment) {
        mFragment = Fragment;
    }
