...
import com.thinkive.android.trade_bz.a_rr.adapter.RSelectQuanDetailAdapter;
import com.thinkive.android.trade_bz.a_rr.bean.RSelectContractBean;
import com.thinkive.android.trade_bz.a_rr.bll.RSelectQuanDetailServiceImpl;
 ...
 */
public class RSelectQuanDetailFragment extends AbsBaseFragment implements OnDateSetListener {
    /**
     *适配器
     */
    private RSelectQuanDetailAdapter mAdapter;
    /**
     *Fragment的宿主
     */
    private RSelectCreditQuanDetailActivity mActivity;
    /**
     *该Fragement的业务类
     */
    private RSelectQuanDetailServiceImpl mServices;
    /**
     * 该类的控制器
     */
    private QuanDetailController mController;
    /**
     * 开始时间
     */
    ...
    protected void initData() {
        mActivity = (RSelectCreditQuanDetailActivity) getActivity();
        mAdapter = new RSelectQuanDetailAdapter(mActivity);
        mServices = new RSelectQuanDetailServiceImpl(this);
        mController = new QuanDetailController(this);
    ...
    protected void initViews() {
        ...
        mServices.requestQuanDetail(mBegin, mEnd);
        //设置禁止上拉加载更多
     ...
     * @param dataList
     */
    public void getDeliveryOrderData(ArrayList<RSelectContractBean> dataList) {
 ...
 * 控制类
 */
class QuanDetailController extends AbsBaseController implements PullToRefreshListView.OnRefreshListener,
        View.OnClickListener {
    private RSelectQuanDetailFragment mFragment;
    public QuanDetailController(RSelectQuanDetailFragment fragment) {
        mFragment = fragment;
    }
    @Override
