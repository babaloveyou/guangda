...
import com.thinkive.android.trade_bz.a_hk.adapter.HKHistoryTradeAdapter;
import com.thinkive.android.trade_bz.a_hk.bean.HKHistoryTradeBean;
import com.thinkive.android.trade_bz.a_hk.bll.HKHistoryTradeServicesImpl;
 ...
 * @date 2015/11/2
 */
public class HKHistoryTradeFragment extends AbsBaseFragment {
    /**
     * 历史成交数据适配器
     */
    private HKHistoryTradeAdapter mAdapter;
    /**
     *历史成交Fragment的宿主
     */
     ...
     *该Fragement的业务类
     */
    private HKHistoryTradeServicesImpl mServices;
    /**
     * 该类的控制器
     */
    private HKHistoryTradeViewController mController;
    /**
     * 开始时间
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_hk_history_trade, null);
        findViews(rootView);
        initData();
        setListeners();
        initViews();
    ...
    protected void initData() {
        ...
        mAdapter = new HKHistoryTradeAdapter(mActivity);
        mServices = new HKHistoryTradeServicesImpl(this);
        mController = new HKHistoryTradeViewController(this);
     ...
     * @param dataList
     */
    public void onGetHistoryTradeData(ArrayList<HKHistoryTradeBean> dataList) {
 ...
 * 历史委托的控制类
 */
class HKHistoryTradeViewController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener,View.OnClickListener {

    private HKHistoryTradeFragment mFragment;

    public HKHistoryTradeViewController(HKHistoryTradeFragment fragment) {
