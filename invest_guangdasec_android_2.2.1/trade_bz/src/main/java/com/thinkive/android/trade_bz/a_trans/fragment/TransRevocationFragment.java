...
import com.thinkive.android.trade_bz.a_trans.adapter.TransRevocationAdapter;
 ...
 * @date 2016/1/5
 */
public class TransRevocationFragment extends AbsBaseFragment {
    private TransRevocationAdapter mAdapter;
    private TKFragmentActivity mActivity;
    private TransRevocationServicesImpl mServices;
    private TransRevocationController mController;
    /**
     * ListView
     */
    ...
    protected void initData() {
        ...
        mServices=new TransRevocationServicesImpl(this);
        mAdapter=new TransRevocationAdapter(mActivity,mServices);
        mController=new TransRevocationController(this);
    }
     ...
     * @param dataList
     */
    public void getRevocationData(ArrayList<TransSelectBean> dataList) {
...
class TransRevocationController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener{

    private TransRevocationFragment mFragment = null;

    public TransRevocationController(TransRevocationFragment Fragment) {
        mFragment = Fragment;
    }
