...
import com.thinkive.android.trade_bz.a_rr.adapter.CreditTodayMoneyAdapter;
import com.thinkive.android.trade_bz.a_rr.bean.RSelectHistoryWaterMoneyBean;
import com.thinkive.android.trade_bz.a_rr.bll.CreditTodayMoneyServiceImpl;
 ...
 */
public class CreditTodayMoneyFragment extends AbsBaseFragment {
    /**
     * 资金流水数据适配器
     */
    private CreditTodayMoneyAdapter mTodayMoneyAdapter;
    /**
     * 资金流水Fragment的宿主
     */
     ...
     * 该Fragement的业务类
     */
    private CreditTodayMoneyServiceImpl mServices;
    /**
     * 控制当日资金流失
     */
    private CreditTodayMoneyViewController mController;
    /**
     *  ListView
     */
    ...
    protected void initData() {
        mTodayMoneyActivity = (CreditMoneyFlowActivity) getActivity();
        mTodayMoneyAdapter = new CreditTodayMoneyAdapter(mTodayMoneyActivity);
        mServices = new CreditTodayMoneyServiceImpl(this);
        mController = new CreditTodayMoneyViewController(this);
    }
     ...
     * @param dataList
     */
    public void onGetTodayMoneyWater(ArrayList<RSelectHistoryWaterMoneyBean> dataList) {
...
class CreditTodayMoneyViewController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener, View.OnClickListener {

    private CreditTodayMoneyFragment mFragment = null;

    public CreditTodayMoneyViewController(CreditTodayMoneyFragment Fragment) {
        mFragment = Fragment;
    }
