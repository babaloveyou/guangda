...
import com.thinkive.android.trade_bz.a_hk.adapter.HKHoldStockAdapter;
import com.thinkive.android.trade_bz.a_hk.bean.HKHoldStockBean;
import com.thinkive.android.trade_bz.a_hk.bll.HKMyHoldStockServiceImpl;
import com.thinkive.android.trade_bz.a_hk.controll.HKMyHoldStockViewController;
 ...
 * @date 15/11/2
 */
public class HKMyHoldStockFragment extends AbsBaseFragment {
    /**
     * 该类的宿主Activity
     */
     ...
     * 我的持仓数据的LisView的适配器
     */
    private HKHoldStockAdapter mAdapter;
    /**
     * 该类的业务类
     */
    private HKMyHoldStockServiceImpl mServiceImpl = null;
    /**
     * 头部viewpager
     */
     ...
     * 头部pager的三个fragment
     */
    private HKHoldPagerFragment mFragmentPagerOne;
    private HKHoldPagerFragment mFragmentPagerTwo;
    private HKHoldPagerFragment mFragmentPagerThird;
    /**
     * 显示小圆点的容器
     */
     ...
     * 控制我的持仓
     */
    private HKMyHoldStockViewController mController;
    /**
     * 正在加载的旋转进度条
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mScrollChild = inflater.inflate(R.layout.fragment_hk_my_hold, null);
        findViews(rootView);
        initData();
        setListeners();
        initViews();
...
//        registerListener(MyHoldStockViewController.ON_ACTION_CLICK, mListView, mController);
    ...
    protected void initData() {
        ...
        mServiceImpl = new HKMyHoldStockServiceImpl(this);
        mController = new HKMyHoldStockViewController(this);
        mAdapter = new HKHoldStockAdapter(mActivity);
        mFragmentList = new ArrayList<AbsBaseFragment>();
        mFragmentPagerOne = new HKHoldPagerFragment();
        mFragmentPagerTwo = new HKHoldPagerFragment();
        mFragmentPagerThird = new HKHoldPagerFragment();
...
//        mListView.setAdapter(mAdapter, R.id.ll_hold_list_item_view, R.id.ll_hold_list_item_expand);
                ...
                public void callback(Object o) {
                    ...
                    try {
                        if(o != null && !o.equals("")){
                            ...
                            ToastUtils.toast(mActivity, mActivity.getResources().getString(R.string.toast_call_back_hq));
                        }
     ...
     * @param dataList
     */
    public void onGetStoreData(ArrayList<HKHoldStockBean> dataList) {
        if (dataList == null || dataList.size() == 0) {
