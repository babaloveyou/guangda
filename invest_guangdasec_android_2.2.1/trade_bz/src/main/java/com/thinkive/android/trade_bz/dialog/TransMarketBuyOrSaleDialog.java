...
//     * 调用方的业务类
//     */
//    private TransMarketBuyOrSaleServiceImpl mService;
//
//    public TransMarketBuyOrSaleDialog(Context context, int mBuyOrSale, TransMarketBuyOrSaleServiceImpl service) {
//        super(context);
