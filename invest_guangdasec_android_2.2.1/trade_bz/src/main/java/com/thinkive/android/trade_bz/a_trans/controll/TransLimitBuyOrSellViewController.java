 ...
 * @date 2015/12/30
 */
public class TransLimitBuyOrSellViewController extends AbsBaseController implements
        View.OnClickListener, ListView.OnItemClickListener, TextWatcher,
        View.OnFocusChangeListener{

    private TransLimitBuyOrSaleFragment mFragment = null;

    public TransLimitBuyOrSellViewController(TransLimitBuyOrSaleFragment fragment) {
        mFragment = fragment;
    }
