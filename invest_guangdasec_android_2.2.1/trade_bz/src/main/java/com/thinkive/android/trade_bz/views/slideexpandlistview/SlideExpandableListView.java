 ...
 */
abstract  class SlideExpandableListView extends ListView {
    ...
    public void setAdapter(ListAdapter adapter, int toggleButtonId, int expandableViewId) {
        this.adapter = new SlideExpandableListAdapter(adapter, toggleButtonId, expandableViewId) {
            @Override
            public void updateListViewLocation(int position) {
    ...
    protected abstract void updateLvLocation();
