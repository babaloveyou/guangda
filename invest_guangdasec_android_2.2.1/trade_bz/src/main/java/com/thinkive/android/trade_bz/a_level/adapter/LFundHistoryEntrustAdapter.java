...
public class LFundHistoryEntrustAdapter extends AbsBaseAdapter<LFundEntrustDataBean> {
    private Context mContext;
    private FontManager mFontManager;
    public LFundHistoryEntrustAdapter(Context context) {
        super(context, R.layout.item_level_history_entrust);
        mContext = context;
    ...
    protected void onFillComponentData(ViewHolder holder, LFundEntrustDataBean bean) {
        ...
        tvTime.setText(bean.getEntrust_date()+" "+bean.getEntrust_time());
