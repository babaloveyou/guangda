...
import com.thinkive.android.trade_bz.a_rr.adapter.RSelectWaterMoneyAdapter;
import com.thinkive.android.trade_bz.a_rr.bean.RSelectHistoryWaterMoneyBean;
import com.thinkive.android.trade_bz.a_rr.bll.RSelectWaterMoneyServiceImpl;
 ...
 * @date 2015/8/19
 */
public class RSelectWaterMoneyFragment extends AbsBaseFragment {
    /**
     *适配器
     */
    private RSelectWaterMoneyAdapter mAdapter;
    /**
     *Fragment的宿主
     */
    private RSelectWaterMoneyActivity mActivity;
    /**
     *该Fragement的业务类
     */
    private RSelectWaterMoneyServiceImpl mServices;
    /**
     * 该类的控制器
     */
    private RWatertViewController mController;
    /**
     * 开始时间
     */
    ...
    protected void initData() {
        mActivity = (RSelectWaterMoneyActivity) getActivity();
        mAdapter = new RSelectWaterMoneyAdapter(mActivity);
        mServices = new RSelectWaterMoneyServiceImpl(this);
        mController = new RWatertViewController(this);
    ...
    protected void initViews() {
        ...
        mServices.requestWaterMoneyData(mBegin, mEnd);
        //设置禁止上拉加载更多
     ...
     * @param dataList
     */
    public void getWaterMoneyData(ArrayList<RSelectHistoryWaterMoneyBean> dataList) {
 ...
 * 控制类
 */
class RWatertViewController extends AbsBaseController implements PullToRefreshListView.OnRefreshListener,
       View.OnClickListener {
    private RSelectWaterMoneyFragment mFragment;
    public RWatertViewController(RSelectWaterMoneyFragment fragment) {
        mFragment = fragment;
    }
    @Override
