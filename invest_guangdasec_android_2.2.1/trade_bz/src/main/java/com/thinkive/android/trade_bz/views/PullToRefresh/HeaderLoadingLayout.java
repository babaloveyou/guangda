package com.thinkive.android.trade_bz.views.PullToRefresh;
...
//    private Animation mRotateDownAnim;
    /*图片动画*/
    private AnimationDrawable mPicAnim;
    /*动画图片*/
...
//        mRotateDownAnim.setFillAfter(true);
        mAnimalImageView = (ImageView) findViewById(R.id.pull_to_refresh_header_animimg);
        mPicAnim = (AnimationDrawable) mAnimalImageView.getDrawable();
    }
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header_trade, null);
        return container;
    }
...
//        mArrowImageView.clearAnimation();
        ...
        mArrowImageView.setBackgroundResource(R.drawable.refresh_pull);
    }
...
// mArrowImageView.clearAnimation();
    ...
    protected void onRefreshingEnd() {
        ...
        mArrowImageView.setBackgroundResource(R.drawable.refresh_pull_success);
        mArrowImageView.setVisibility(View.VISIBLE);
