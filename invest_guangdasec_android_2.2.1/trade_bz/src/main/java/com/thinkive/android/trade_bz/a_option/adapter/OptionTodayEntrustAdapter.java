...
public class OptionTodayEntrustAdapter extends AbsBaseAdapter<OptionTodayEntrustBean> {
    ...
    public OptionTodayEntrustAdapter(Context context) {
        super(context, R.layout.item_option_today_entrust);
        mContext = context;
        mFontManager = FontManager.getInstance(mContext);
    }

    @Override
    protected void onFillComponentData(ViewHolder holder, OptionTodayEntrustBean bean) {
        ...
        tvEntrustStateName.setText(bean.getEntrust_status_name());
        //todo：缺字段
