...
public class OptionHistoryEntrustAdapter extends AbsBaseAdapter<OptionHistoryEntrustBean> {
    ...
    public OptionHistoryEntrustAdapter(Context context) {
        super(context, R.layout.item_option_history_entrust);
        mContext = context;
        mFontManager = FontManager.getInstance(mContext);
    }

    @Override
    protected void onFillComponentData(ViewHolder holder, OptionHistoryEntrustBean bean) {
