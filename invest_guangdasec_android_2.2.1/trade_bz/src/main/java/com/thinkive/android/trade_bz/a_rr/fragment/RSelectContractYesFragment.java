...
import com.thinkive.android.trade_bz.a_rr.adapter.RSelectContractYesAdapter;
import com.thinkive.android.trade_bz.a_rr.bean.RSelectContractBean;
import com.thinkive.android.trade_bz.a_rr.bll.RSelectContractYesServiceImpl;
 ...
 * @date 2015/8/18
 */
public class RSelectContractYesFragment extends AbsBaseFragment {
    /**
     *数据适配器
     */
    private RSelectContractYesAdapter mAdapter;
    /**
     * Fragment的宿主
     */
    private RSelectContractYesActivity mActivity;
    /**
     *该Fragement的业务类
     */
    private RSelectContractYesServiceImpl mServices;
    /**
     * 该类的控制器
     */
    private RContractYesController mController;
    /**
     * 查询开始时间
     */
    ...
    protected void initData() {
        mActivity = (RSelectContractYesActivity) getActivity();
        mAdapter = new RSelectContractYesAdapter(mActivity);
        mServices = new RSelectContractYesServiceImpl(this);
        mController = new RContractYesController(this);
    ...
    protected void initViews() {
        ...
        //调用业务类中，初始化数据的方法
        mServices.requestContractYesData(mBegin,mEnd);
     ...
     * @param dataList
     */
    public void getContractYesData(ArrayList<RSelectContractBean> dataList) {
 ...
 * 控制类
 */
class RContractYesController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener,View.OnClickListener {

    private RSelectContractYesFragment mFragment;

    public RContractYesController(RSelectContractYesFragment fragment) {
