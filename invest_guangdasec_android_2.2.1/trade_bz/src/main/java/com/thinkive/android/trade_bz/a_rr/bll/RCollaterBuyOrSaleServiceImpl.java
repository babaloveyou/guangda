 ...
 * @date 2016/1/20
 */
public class RCollaterBuyOrSaleServiceImpl extends BasicServiceImpl {
    ...
    public RCollaterBuyOrSaleServiceImpl(RCollaterBuyOrSellFragment fragment) {
        mFragment = fragment;
    ...
    public void requestLinkageData(final String stock_code, String entrustPrice,
                                   final String exchangeType, final String market, String entrustBs) {
