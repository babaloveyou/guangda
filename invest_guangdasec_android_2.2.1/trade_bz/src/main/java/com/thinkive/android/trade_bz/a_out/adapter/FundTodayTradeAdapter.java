...
public class FundTodayTradeAdapter extends AbsBaseAdapter<FundTodayTradeBean> {
    private Context mContext;
    private FontManager mFontManager;
    public FundTodayTradeAdapter(Context context) {
        super(context, R.layout.item_fund_today_trade);
        mContext = context;
        mFontManager = FontManager.getInstance(mContext);
    }
    @Override
    protected void onFillComponentData(ViewHolder holder, FundTodayTradeBean bean) {
