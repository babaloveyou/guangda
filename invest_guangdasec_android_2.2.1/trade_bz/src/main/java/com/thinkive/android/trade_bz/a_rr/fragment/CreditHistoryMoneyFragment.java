...
public class CreditHistoryMoneyFragment  extends AbsBaseFragment implements OnDateSetListener {
    ...
    protected void initData() {
        ...
        mTodayMoneyAdapter = new CreditHistoryMoneyAdapter(mTodayMoneyActivity);
        mServices = new CreditHistoryMoneyServiceImpl(this);
        mController = new CreditHistoryMoneyViewController(this);
...
class CreditHistoryMoneyViewController extends AbsBaseController implements
        PullToRefreshListView.OnRefreshListener, View.OnClickListener {

    private CreditHistoryMoneyFragment mFragment = null;

    public CreditHistoryMoneyViewController(CreditHistoryMoneyFragment Fragment) {
        mFragment = Fragment;
    }
