 ...
 * @date 2016/1/6
 */
public class Trans301709 extends BaseNormalRequest {

    public static final String BUNDLE_KEY_HISTORY_TRADE = "Trans301709";

    public Trans301709(HashMap<String, String> paramMap, IRequestAction action) {
        super(action);
        paramMap.put("funcNo", "301709");
