...
public class NewDistributeAdapter extends AbsBaseAdapter<NewDistributeNumBean> {

    private FontManager mFontManager;

    public NewDistributeAdapter(Context context) {
        super(context, R.layout.item_new_distribute);
        mFontManager = FontManager.getInstance(context);
    }

    @Override
    protected void onFillComponentData(ViewHolder holder, NewDistributeNumBean bean) {
