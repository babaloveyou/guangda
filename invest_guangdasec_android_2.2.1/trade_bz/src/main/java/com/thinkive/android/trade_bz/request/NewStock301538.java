 ...
 * @date 2015/12/31
 */
public class NewStock301538 extends BaseNormalRequest {

    public static final String BUNDLE_KEY_TODAY_TOTAL_STOCK = "NewStock301538";

    public NewStock301538(HashMap<String, String> params, IRequestAction action) {
        super(action);
        params.put("funcNo", "301538");
