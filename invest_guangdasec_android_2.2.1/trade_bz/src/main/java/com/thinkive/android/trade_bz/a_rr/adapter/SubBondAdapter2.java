 ...
 */
public class SubBondAdapter2 extends AbsBaseAdapter<RSelectCollaterSecurityBean> {
    private Context mContext;

    public SubBondAdapter2(Context context) {
        super(context, R.layout.item_r_sub_bond2);
        mContext = context;
    }
    ...
    protected void onFillComponentData(ViewHolder holder, final RSelectCollaterSecurityBean bean) {
        ...
        TextView saleAmountTv = (TextView) holder.getComponentById(R.id.tv_sale_amount);
        saleAmountTv.setText(bean.getEnable_amount());
