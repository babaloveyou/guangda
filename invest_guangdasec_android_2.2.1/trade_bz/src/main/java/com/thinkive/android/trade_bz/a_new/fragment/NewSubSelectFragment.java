...
import com.thinkive.android.trade_bz.a_new.adapter.NewSubSelectAdapter;
import com.thinkive.android.trade_bz.a_new.bean.NewDistributeNumBean;
import com.thinkive.android.trade_bz.a_new.bll.NewSubSelectServicesImpl;
 ...
 * @date 2016/6/22
 */
public class NewSubSelectFragment extends AbsBaseFragment {
    private NewSubSelectServicesImpl mServices;
    private TKFragmentActivity mActivity;
    private NewSubSelectAdapter mAdapter;
    private NewSubSelectController mController;
    /**
     * ListView
     */
    ...
    protected void initData() {
        ...
        mServices =new NewSubSelectServicesImpl(this,mUserType);
        mAdapter =new NewSubSelectAdapter(mActivity);
        mController=new NewSubSelectController(this);
...
class NewSubSelectController extends AbsBaseController implements PullToRefreshListView.OnRefreshListener,
       View.OnClickListener{

    private NewSubSelectFragment mFragment = null;

    public NewSubSelectController(NewSubSelectFragment Fragment) {
        mFragment = Fragment;
    }
