 ...
 * @date 2016/8/23
 */
public class RReturnMoneyAdapter extends AbsBaseAdapter<RChooseContractBean> {

    private Context mSubContext;
    private FontManager mFontManager;

    public RReturnMoneyAdapter(Context context) {
        super(context, R.layout.item_r_choose_contract_return_money);
